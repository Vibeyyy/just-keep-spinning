...
func _on_button_to_read_mail_pressed() -> void:
	...
	if letter.id == "weirdo_willy":
		...
		print("weeds_spawning")
		print("opens mail!")
	if letter.id == "salesman_sam":
...
#Start timers_for_letter_spawns


# timers for letter spawns
